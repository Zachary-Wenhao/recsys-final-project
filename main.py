...
parser.add_argument('--batch_size', default=5, type=int) #50 in first paper and 32 in second paper
...
parser.add_argument('--train_data', default='recSysTrain_1000.txt', type=str)
parser.add_argument('--valid_data', default='recSysTest_300.txt', type=str)
...
def main():
    ...
    # sub-sampling for baseline (10% of each dataset)
    '''
