...
dataBefore = './yoochoose-data/yoochoose-clicks.dat' #Path to Original Training Dataset "Clicks" File
dataTestBefore = './yoochoose-data/yoochoose-test.dat' #Path to Original Testing Dataset "Clicks" File
dataAfter = './data_after/' #Path to Processed Dataset Folder
